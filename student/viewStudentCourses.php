...
<div id="right-panel" class="right-panel">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><h2 align="center">All Courses for (<?php echo $levelName;?>)</h2></strong>
                        </div>
                        <div class="card-body">
   ...
   tbllevel.levelName,tblcourse.courseUnit, tblfaculty.facultyName,tbldepartment.departmentName
    ...
    where tblfaculty.Id = '$facultyId' and tbldepartment.Id = '$departmentId' and tbllevel.Id = '$levelId'");
