...
if(isset($_GET['editId'])){
    ...
    $query = mysqli_query($con,"select * from tblassignments where Id='$_SESSION[editId]'");
...
if($ret > 0){
  ...
  $statusMsg="This Assignment with title ".$title." Already exists!";
    ...
    if (in_array($assignmentfileExtension, $allowedfileExtensions)) {
        ...
        $query=mysqli_query($con,"update tblassignments set staffId='$staffId',title='$title',description='$description',scoreObtainable='$scoreObtainable',
        passMark='$passMark', deadLineDate='$deadLineDate', assignment='$assignmentnewFileName',levelId='$levelId',courseId='$courseId'
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Scheduled Assignments</li>
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="content">
        <div class="animated fadeIn">
                                   ...
                                   <div class="<?php echo $alertStyle;?>" role="alert"><?php echo $statusMsg;?></div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="" name="title" type="text" class="form-control cc-exp" value="<?php echo $rowi['title']?>" Required data-val="true" placeholder="Title">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <label for="x_card_code" class="control-label mb-1">Description</label>
                                                    <input id="" name="description" type="text" class="form-control cc-cvc" value="<?php echo $rowi['description']?>" Required  placeholder="Description">
                                                    </div>
                                                </div>
                                                <div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="" name="scoreObtainable" type="text" class="form-control cc-exp" onkeypress="return isNumber(event)" value="<?php echo $rowi['scoreObtainable']?>" Required placeholder="Score Obtainable">
                                                </div>
                                            </div>
                                        <div class="col-6">
                                        <div class="form-group">
                                                    <label for="cc-exp" class="control-label mb-1">Pass Mark</label>
                                                    <input id="" name="passMark" type="text" class="form-control cc-exp" onkeypress="return isNumber(event)" value="<?php echo $rowi['passMark']?>" Required placeholder="Pass Mark">
                                                </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="" name="deadLineDate" type="date" class="form-control" value="<?php echo $rowi['deadLineDate']?>" Required placeholder="Score Obtainable">
                                                </div>
                                            </div>
                                        <div class="col-6">
                                        <div class="form-group">
                                                    <label for="cc-exp" class="control-label mb-1">Assignment</label>
                                                    <input name="assignmentFile" type="file" class="form-control" value="<?php echo $rowi['assignment']?>" Required placeholder="Pass Mark">
                                                </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" name="submit" class="btn btn-primary">Update Assignment</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            <br><br>
                ...
                <td><a href="editScheduledAssignment.php?editId=<?php echo $row['Id'];?>" title="Edit Details"><i class="fa fa-edit fa-1x"></i></a></td>
                <td><a onclick="return confirm('Are you sure you want to delete?')" href="deleteScheduledAssignment.php?delid=<?php echo $row['Id'];?>" title="Delete Student Details"><i class="fa fa-trash fa-1x"></i></a></td>
                </tr>
                <?php 
                $cnt=$cnt+1;
                }?>
