...
if(isset($_GET['assignmentId'])){
    ...
    echo "<script type = \"text/javascript\">
        window.location = (\"viewSubmittedAssignments.php\")
        </script>"; 
    }
    ...
    if(isset($_POST['submit'])){
        ...
        $assignmentSubmittedId = $_POST['assignmentSubmittedId'];
        $N = count($assignmentSubmittedId);

        $scoreObtained = $_POST['scoreObtained'];
        ...
        for($i = 0; $i < $N; $i++)
        {
            ...
            //compare the passmark and the score student obtained
            $scoreStatus = "Failed";
            if($scoreObtained[$i] >= $passMark){
                $scoreStatus = "Passed";
            }

            $querys=mysqli_query($con,"update tblassignmentsubmitted set scoreObtained=' $scoreObtained[$i]',scoreStatus='$scoreStatus',
            staffNotes='$staffNotes[$i]', isGraded=1,dateGraded='$dateGraded' where Id='$assignmentSubmittedId[$i]'");
    
            if ($querys) {
                
                $alertStyle ="alert alert-success";
                $statusMsg="Assignments Graded Successfully!";
            }
            else
            {
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Submitted Assignments</li>
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="content">
        <div class="animated fadeIn">
            ...
            <br><br>
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><h2 align="center">All Assignments Submitted</h2></strong>
                        </div>
                ...
                <input name="assignmentSubmittedId[]" type="hidden" class="form-control" value="<?php echo $row['assignmentSubmittedId'];?>">
                <td><input name="scoreObtained[]" type="text" class="form-control" value="" maxlength="3" onkeypress="return isNumber(event)"></td>
                <td><input name="staffNotes[]" type="text" style="width:300px;" class="form-control" value="" Required></td>
                ...
                $cnt=$cnt+1;
                        ...
                        <button type="submit" onclick="" name="submit" class="btn btn-primary" style="margin-left:600px;">Grade Assignments</button>
                    </form>
                    </div>
                </div>
            </div>
