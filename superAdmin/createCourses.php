...
if(isset($_POST['submit'])){
    ...
    $query=mysqli_query($con,"select * from tblcourse where courseTitle ='$courseTitle' and departmentId ='$departmentId' and levelId = '$levelId'");
    $ret=mysqli_fetch_array($query);

    if($ret > 0){ //Check the coure Title
 
      $alertStyle ="alert alert-danger";
      $statusMsg="This Course already exist in this department for this Level!";

    }
    else{

        $query=mysqli_query($con,"insert into tblcourse(courseTitle,courseCode,courseUnit,levelId,facultyId,departmentId,staffId,dateAdded) value('$courseTitle','$courseCode','$courseUnit','$levelId','$facultyId','$departmentId','$staffId','$dateAdded')");
